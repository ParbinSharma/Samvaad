...
$get_info_sql = "SELECT * FROM `Accounts` WHERE `Username`='$Username'";
...
<button type="button" class="submit" style="top:395px;left:-50px;" id="subdesk" onclick="window.location.href ='/Dashboard.php'" >Confirm</button>
...
<input class="credentials" type="text" id="up_description" name="up_description" placeholder="Description" maxlength="24" onkeydown="limit(this);" value='<?php echo $description; ?>' onkeyup="limit(this);" />
<input class="credentials" type="text" placeholder="Email" value='<?php echo $email; ?>' id="up_email" name="up_email" />
<input class="credentials" type="text" placeholder="Date Of Birth" value='<?php echo $dob; ?>' onfocus="(this.type='date')" id="up_dob" name="up_dob" />
